    ...
    <div class="content">
        ...
        <div class="main_page">
            ...
            <div class="main_page_kw">
                ...
                <div>
                    ...
                    <div class="board">
                        ...
                        <script src="/project_second/assets/JavaScript/chart.js"></script>
                    </div>
            ...
            <div class="main_page_kw">
                ...
                <div>
                    <!-- 게시판 -->
                    <h2><a href="게시판.html">공지사항(게시판)</a></h2>
                    <button id="button1" class="btn">글쓰기</button>
                    <script>
                        document.getElementById('button1').addEventListener('click', function () {
                            window.open('글쓰기.html', '글쓰기', 'width=400,height=500');
                        });
                    </script>
                    <table class="table">
                        <thead>
                    ...
                    <script src="/project_second/assets/JavaScript/게시판.js"></script>
                </div>
