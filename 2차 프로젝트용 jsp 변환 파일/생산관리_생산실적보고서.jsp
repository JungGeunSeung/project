                ...
                <li class="menu-item">
                    ...
                    <div class="submenu">
                        <ul>
                            ...
                            <li><a href="정보_설비코드.html">설비코드</a></li>
                ...
                <li class="menu-item">
                    ...
                    <div class="submenu">
                        <ul>
                            ...
                            <li><a href="재고관리_재고관리.html">재고관리</a></li>
                ...
                <li class="menu-item">
                    ...
                    <div class="submenu">
                        <ul>
                            ...
                            <li><a href="생산관리_작업지시서 목록.html">작업지시목록(생산계획_권)</a></li>
...
<script src="/project_second/assets/JavaScript/proper.js"></script>
