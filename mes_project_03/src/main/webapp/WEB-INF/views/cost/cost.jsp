...
<body>
			...
			<c:forEach var="material" items="${materialList}">
				<tr>
					...
					<td>
						...
						<button class="btn"
							onclick="openEditModal('${material.cost_id}', '${material.product_id}', '${material.material_cost}', '${material.labor_cost}', '${material.over_cost}', '${material.total}')">
							<span>수정</span>
						</button>
					</td>
					<td>
	...
	<div id="editModal" class="modal">
		<div class="modal-content">
			...
			<form id="editForm" method="post" action="/gaw/cost/update">
				<input type="hidden" id="editCostId" name="cost_id"> <label
					for="product_id">제품 ID:</label> <input type="text"
					id="editProductId" name="product_id"><br> <label
					for="material_cost">재료비:</label> <input type="text"
					id="editMaterialCost" name="material_cost"><br> <label
					for="labor_cost">인건비:</label> <input type="text" id="editLaborCost"
					name="labor_cost"><br> <label for="over_cost">간접비:</label>
				<input type="text" id="editOverCost" name="over_cost"><br>
				<label for="total">총합 금액:</label> <input type="text" id="editTotal"
					name="total"><br>
	...
	<div id="addModal" class="modal">
		<div class="modal-content">
			...
			<form id="addForm" method="post" action="/gaw/cost/add">
				<label for="product_id">원가 ID:</label> <input type="text"
					id="addProductId" name="cost_id"><br> <label
					for="product_id">제품 ID:</label> <input type="text"
					id="addProductId" name="product_id"><br> <label
					for="material_cost">재료비:</label> <input type="text"
					id="addMaterialCost" name="material_cost"><br> <label
					for="labor_cost">인건비:</label> <input type="text" id="addLaborCost"
					name="labor_cost"><br> <label for="over_cost">간접비:</label>
				<input type="text" id="addOverCost" name="over_cost"><br>
				<label for="total">총합 금액:</label> <input type="text" id="addTotal"
					name="total"><br>
	...
	<script>
		...
		function openEditModal(costId, productId, materialCost, laborCost,
				overCost, total) {
