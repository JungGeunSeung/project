...
<body>
	<div class="container">
		...
		<div class="agreement-item">
			<div class="agreement-header">
				<label for="agree-all"> <input type="checkbox"
					id="agree-all"> <strong>전체 동의하기</strong>
				</label> <span>[선택포함]</span>
			</div>
		</div>
		...
		<div class="agreement-item">
			<div class="agreement-header">
				<label for="agree1"> <input type="checkbox" id="agree1"
					class="agree"> 원대한 올 승리 이용약관 동의
				</label> <span>[필수]</span>
			</div>
			<div class="agreement-content">
				<p>원대한 올 승리 서비스 이용약관에 따라, 원대한 올 승리 서비스는 다양한 디지털 콘텐츠와 관련된 서비스를
					제공합니다. 본 약관은 원대한 올 승리 서비스 이용자와 원대한 올 승리 간의 권리와 의무를 명시합니다.</p>
			</div>
		</div>
		...
		<div class="agreement-item">
			<div class="agreement-header">
				<label for="agree2"> <input type="checkbox" id="agree2"
					class="agree"> 개인정보 수집 및 이용 동의
				</label> <span>[필수]</span>
			</div>
			<div class="agreement-content">
				<p>원대한 올 승리는 사용자 개인 정보를 안전하게 보호하며, 관련 법규에 따라 개인 정보를 수집하고 이용합니다.
					개인정보는 서비스 제공을 위해 필요한 최소한의 정보로만 수집됩니다.</p>
			</div>
		</div>
		...
		<div class="agreement-item">
			<div class="agreement-header">
				<label for="agree3"> <input type="checkbox" id="agree3"
					class="agree"> 위치기반서비스 이용약관 동의
				</label> <span>[선택]</span>
			</div>
			<div class="agreement-content">
				<p>위치기반서비스는 사용자의 현재 위치를 기반으로 맞춤형 정보를 제공합니다. 위치 정보는 사용자의 동의 하에만
					수집됩니다.</p>
			</div>
		</div>
	...
	<script>
        ...
        // 필수 항목이 모두 체크되면 "다음" 버튼 활성화, 하나라도 체크 해제되면 비활성화
		function toggleSubmitButton() {
		    const allRequiredChecked = Array.from(individualCheckboxes)
		        .filter(cb => cb !== agree3) // 필수 항목 체크박스만 확인 (agree3 제외)
		        .every(cb => cb.checked); // 모두 체크되어 있는지 확인
