			...
			<c:forEach var="material" items="${materialList}">
				<tr>
					...
					<td>
						<!-- 수정 버튼 -->
						<button class="btn"
							onclick="openUpdateModal('${material.material_id}', '${material.material_name}', '${material.quantity}', '${material.unit}')">
							<span>수정</span>
						</button>
					</td>
					<td>
		...
		<div class="modal-content">
			...
			<form action="/gaw/material/insert" method="post">
				...
				<label for="quantity">수량:</label> <input type="number" id="quantity"
					name="quantity" required><br> <label for="unit">단위:</label>
	...
	<div id="updateModal" class="modal">
		<div class="modal-content">
			...
			<form action="/gaw/material/update" method="post">
				...
				<label for="update_material_name">제품 이름:</label> <input type="text"
					id="update_material_name" name="material_name" required><br>
				<label for="update_quantity">수량:</label> <input type="number"
					id="update_quantity" name="quantity" required><br> <label
					for="update_unit">단위:</label> <input type="text" id="update_unit"
					name="unit" required><br> <input type="submit"
					value="수정" class="btn">
			</form>
		</div>
	</div>
