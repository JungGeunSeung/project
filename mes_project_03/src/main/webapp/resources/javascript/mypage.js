...
function editEmail() {
    ...
    <form action="emailUpdate" method="post">
        <input type="email" name="email" id="newEmail" placeholder="새 이메일 입력" value="${user.email}"><br>
        <input type="text" id="verification-code" placeholder="이메일 인증 코드 입력"><br>
        <button class="btn certi" type="button" onclick="verifyEmail(event)"><span>인증 코드 발송</span></button>
...
function editName() {
    ...
    <form action="nameUpdate" method="post">
        <input type="text" name="name" id="newName" placeholder="새 이름 입력" value="${user.name}"><br>
...
function editPhone() {
    ...
    <form action="phoneUpdate" method="post">
        <input type="text" name="phone" id="newPhone" placeholder="새 휴대폰 번호 입력" value="${user.phone}"><br>
