...
<body>
	...
	<div id="addRowModal" class="modal">
		<div class="modal-content">
			...
			<h2>추가할 품질 정보 입력</h2>
			<form id="addRowForm">
				<label for="prodNum">불량기록 ID :</label> <input type="text" id="prodNum"
					name="prodNum" required><br>
				<label for="LOTNum">품질검사 ID : </label> <input type="text" id="LOTNum" name="LOTNum"
					required><br>
				...
				<label for="count">불량수량 :</label> <input type="number" id="count" name="count"
					required><br>
	...
	<div class="tableID">
		...
		<div>
			<hr>
			<div class="pagenum">
				<% Map map=(Map) request.getAttribute("map"); int totalCount=(int)
					map.get("totalCount"); String str_countPerPage=(String)
					request.getAttribute("countPerPage"); int
