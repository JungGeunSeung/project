...
<body>
	...
	<div class="searchID">
		...
		<!-- 게시물의 개수를 표시할 select -->
		<div class="cntdiv">
			<span>게시물</span> <select name="cnt" id="cnt"
			...
			<div>
				...
				<span>날짜별 조회</span> <input type="date" id="startdate"> ~ <input
	...
	<form method="post" action="modify">
		불량기록 ID : <input type="hidden" name="report_id"
			value="${dto.report_id}">${dto.report_id}<br> 품질검사 ID :
		...
		불량수량 : <input type="number" name="defect_count"
			value="${dto.defect_count}"><br> <input type="submit"
