	...
	<% MaterialDTO dto=(MaterialDTO) request.getAttribute("dto"); %>
		...
		<form method="post" id="send_form">
			...
			<label for="column2">제품번호 : </label> <input type="text" id="productnum"
				name="productnum" value="<%=dto.getprodNum()%>"><br>
			...
			<br> <br>
			<label for="column2">갯수 : </label> <input type="text" id="count"
				name="count" value="<%=dto.getCnt()%>"><br>
			<br> <label for="date">Date:</label> <input type="date" id="inspectdate"
				name="inspectdate" value="<%=dto.getDate()%>"><br>
