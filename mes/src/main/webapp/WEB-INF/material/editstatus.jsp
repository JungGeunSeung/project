...
<body>
	...
	<form method="post" id="send_form">
		<label for="column2">제품번호 : </label> <input type="text"
			id="productnum" name="prodnum" value="<%=dto.getProdnum()%>"><br>
		...
		<br> <label for="column2">갯수 : </label> <input type="text"
			id="quantity" name="quantity" value="<%=dto.getTquantity()%>" readonly><br>
		<br> <label for="column2">규격 : </label> <input type="text"
			id="spec" name="spec" value="<%=dto.getSpec()%>"><br>
		<br> <label for="column2">위치 : </label> <input type="text" id="loc"
			name="loc" value="<%=dto.getStorage_loc()%>"><br> 
		<br> <label
			for="date">Date:</label> <input type="date" id="editdate"
